    ...
    <main className='h-[18vh] bg-bg4 rounded-xl p-1 text-sm text-text3 flex flex-col justify-between items-start'>
        ...
        <section className='flex w-full justify-center items-center'>
            <div className='flex gap-2 p-2 hover:bg-bg3 rounded-xl w-full transition-all'>
                <Image src='/avatars/1.jpg' height={40} width={40} alt='user' className='rounded-full max-h-10 max-w-10' />
            ...
            <div className='flex gap-1 text-lg'>
                    <div className='p-1 hover:bg-bg2 rounded-lg transition-all cursor-pointer'><BsMicFill/></div>
                    <div className='p-1 hover:bg-bg2 rounded-lg transition-all  cursor-pointer'><BsHeadphones/></div>
                    <div className='p-1 hover:bg-bg2 rounded-lg transition-all  cursor-pointer'><BsGearFill /></div>
